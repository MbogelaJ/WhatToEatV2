...
# Safety ratings: SAFE (healthy), LIMIT (moderate), AVOID (unhealthy)
# Local Food Database with safety ratings
LOCAL_FOODS = [
    # Fruits - Mostly SAFE
    ...
    {"id": "beef-1", "name": "Beef, ground, cooked", "brand": None, "category": "Proteins", "safety": "LIMIT", "calories": 250, "protein": 26, "carbs": 0, "fat": 15, "fiber": 0, "serving_size": "100g"},
    ...
    {"id": "turkey-1", "name": "Turkey breast, cooked", "brand": None, "category": "Proteins", "safety": "SAFE", "calories": 135, "protein": 30, "carbs": 0, "fat": 0.7, "fiber": 0, "serving_size": "100g"},
    {"id": "pork-1", "name": "Pork loin, cooked", "brand": None, "category": "Proteins", "safety": "LIMIT", "calories": 143, "protein": 26, "carbs": 0, "fat": 3.5, "fiber": 0, "serving_size": "100g"},
    ...
    {"id": "lamb-1", "name": "Lamb, cooked", "brand": None, "category": "Proteins", "safety": "LIMIT", "calories": 294, "protein": 25, "carbs": 0, "fat": 21, "fiber": 0, "serving_size": "100g"},
    ...
    {"id": "cereal-1", "name": "Cereal, corn flakes", "brand": None, "category": "Grains", "safety": "AVOID", "calories": 357, "protein": 7, "carbs": 84, "fat": 0.4, "fiber": 3.3, "serving_size": "100g"},
    {"id": "tortilla-1", "name": "Tortilla, flour", "brand": None, "category": "Grains", "safety": "LIMIT", "calories": 312, "protein": 8, "carbs": 52, "fat": 8, "fiber": 2.1, "serving_size": "100g"},
    ...
    {"id": "yogurt-1", "name": "Yogurt, plain", "brand": None, "category": "Dairy", "safety": "SAFE", "calories": 61, "protein": 3.5, "carbs": 4.7, "fat": 3.3, "fiber": 0, "serving_size": "100g"},
    ...
    {"id": "cottage-cheese-1", "name": "Cottage cheese", "brand": None, "category": "Dairy", "safety": "SAFE", "calories": 98, "protein": 11, "carbs": 3.4, "fat": 4.3, "fiber": 0, "serving_size": "100g"},
    ...
    # Nuts & Seeds - Mostly SAFE but calorie dense
    ...
    {"id": "peanut-butter-1", "name": "Peanut butter", "brand": None, "category": "Nuts & Seeds", "safety": "LIMIT", "calories": 588, "protein": 25, "carbs": 20, "fat": 50, "fiber": 6, "serving_size": "100g"},
    
    # Beverages - Mixed safety
    {"id": "coffee-1", "name": "Coffee, brewed", "brand": None, "category": "Beverages", "safety": "SAFE", "calories": 2, "protein": 0.3, "carbs": 0, "fat": 0, "fiber": 0, "serving_size": "100ml"},
    {"id": "tea-1", "name": "Tea, brewed", "brand": None, "category": "Beverages", "safety": "SAFE", "calories": 1, "protein": 0, "carbs": 0.3, "fat": 0, "fiber": 0, "serving_size": "100ml"},
    {"id": "orange-juice-1", "name": "Orange juice", "brand": None, "category": "Beverages", "safety": "LIMIT", "calories": 45, "protein": 0.7, "carbs": 10, "fat": 0.2, "fiber": 0.2, "serving_size": "100ml"},
    ...
    {"id": "chips-potato-1", "name": "Potato chips", "brand": None, "category": "Snacks", "safety": "AVOID", "calories": 536, "protein": 7, "carbs": 53, "fat": 35, "fiber": 4.4, "serving_size": "100g"},
    ...
    {"id": "crackers-1", "name": "Crackers, saltine", "brand": None, "category": "Snacks", "safety": "LIMIT", "calories": 421, "protein": 9, "carbs": 74, "fat": 9, "fiber": 2.5, "serving_size": "100g"},
