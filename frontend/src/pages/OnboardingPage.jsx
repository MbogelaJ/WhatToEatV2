          ...
          <div className="space-y-6" data-testid="step-auth">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <div className="space-y-3 mb-6">
                <button
                  type="button"
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-stone-200 rounded-xl hover:bg-stone-50 transition-colors"
                ...
                <button
                  type="button"
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-black text-white rounded-xl hover:bg-stone-800 transition-colors"
                ...
                <button
                  type="button"
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] text-white rounded-xl hover:opacity-90 transition-opacity"
