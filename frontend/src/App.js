...
const CreateAccountPage = ({ onNext, onBack, onAuthSuccess }) => {
  ...
  const handleEmailAuth = () => {
    ...
    setSuccessMessage(isSignIn ? 'Signed in successfully!' : 'Account created successfully!');
    setError('');
  };

  // Continue button - only works after authentication
  const handleContinue = () => {
    if (!isUserAuthenticated) {
      setError('Please sign in with Google, Apple, or create an account first');
      return;
    }
    onNext();
  };
  ...
  return (
    <div className="onboarding-page" data-testid="create-account-page">
      ...
      <div className="onboarding-card">
        ...
        {successMessage && (
          <div className="auth-success-message" data-testid="auth-success">
            <Check size={16} />
        ...
        {isUserAuthenticated && (
          <div className="auth-success-content">
            ...
            <p>You're all set! Tap Continue to proceed.</p>
          </div>
        )}
